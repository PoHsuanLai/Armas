//! Build script to parse transport SVG icons at compile time
//!
//! This script:
//! 1. Scans the `icons/transport/` directory for SVG files
...
fn main() {
    ...
    let dest_path = Path::new(&out_dir).join("transport_icons.rs");
