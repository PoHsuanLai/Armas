...
/// Progress color variants for semantic meaning
...
/// use armas::components::LinearProgress;
///
/// // Determinate progress (0.0 to 1.0)
/// LinearProgress::new(0.65).show(ui);
///
...
pub struct LinearProgress {
    ...
    width: Option<f32>,
    /// Custom color (overrides color_variant)
    color: Option<Color32>,
    /// Semantic color variant
    color_variant: Option<ProgressColor>,
...
impl LinearProgress {
    ...
    /// Set semantic color variant (Primary, Success, Warning, Error, Info)
    pub fn color_variant(mut self, variant: ProgressColor) -> Self {
        self.color_variant = Some(variant);
        self
    }

    /// Set custom progress color (overrides color_variant)
    ...
    pub fn show(mut self, ui: &mut Ui) -> egui::Response {
        ...
        // Priority: custom color > color_variant > default primary
        let primary_color = self.color.unwrap_or_else(|| {
            self.color_variant
                .map(|v| v.color(&theme))
...
/// # use egui::Ui;
/// # fn example(ui: &mut Ui) {
/// use armas::components::CircularProgressBar;
///
/// // Determinate progress (0.0 to 1.0)
