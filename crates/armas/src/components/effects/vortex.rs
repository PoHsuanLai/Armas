...
impl VortexBackground {
    ...
    pub fn show(&mut self, ui: &mut Ui) -> Response {
        ...
        if self.colors.is_empty() {
            ...
            self.colors = vec![
                Color32::from_rgba_unmultiplied(c1.r(), c1.g(), c1.b(), 80),
                Color32::from_rgba_unmultiplied(c2.r(), c2.g(), c2.b(), 70),
                Color32::from_rgba_unmultiplied(c3.r(), c3.g(), c3.b(), 60),
            ];
        }
        ...
        if ui.is_rect_visible(rect) {
            ...
            for ring in 0..self.ring_count {
                ...
                for i in 0..self.particle_count {
                    ...
                    // Draw glow around particle using unified GlowEffect
                    let glow_color = Color32::from_rgba_unmultiplied(
                        color.r(),
                        color.g(),
                        color.b(),
                        (color.a() as f32 * fade * 0.3) as u8,
                    );
                    let glow = GlowEffect::new(
                        GlowConfig::new(glow_color)
                            .layers(2)
                            .expansion(4.0) // 2 layers * 2.0 expansion each
                            .intensity(1.0),
                    );
                    glow.render_radial(&painter, pos, self.particle_size);
                }
            ...
            // Draw center glow using unified GlowEffect
            ...
            let glow = GlowEffect::new(
                GlowConfig::new(glow_color)
                    .layers(8)
                    .expansion(0.0) // radial glow, no expansion needed
                    .intensity(1.0),
            );
            glow.render_radial(&painter, center, max_radius * 0.1);
        }
