...
use crate::effects::presets::GlowPresets;
use crate::effects::GlowEffect;
...
impl Sparkle {
    ...
    fn draw(&self, painter: &egui::Painter, time: f32) {
        ...
        // Add glow using unified GlowEffect
        ...
        let glow_effect = GlowEffect::new(GlowPresets::particle(glow_color));
        glow_effect.render_radial(painter, self.position, self.size);
    }
}
