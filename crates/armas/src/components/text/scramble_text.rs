...
impl ScrambleText {
    ...
    pub fn frame_interval(mut self, interval: f32) -> Self {
...
impl ArmasViewMut for ScrambleText {
...
impl ArmasModifiers for ScrambleText {}
...
mod tests {
    ...
    fn test_scramble_config() {
        let st = ScrambleText::new("Test").speed(5.0).looping(true);
