...
impl GradientCard {
    ...
    fn get_gradient_color(&self, t: f32) -> Color32 {
        ...
        self.blend_colors(
            self.gradient_colors[index],
            self.gradient_colors[next_index],
            blend,
        )
    }

    /// Blend two colors
    fn blend_colors(&self, c1: Color32, c2: Color32, t: f32) -> Color32 {
